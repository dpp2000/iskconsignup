   ...
   <center>
      <body>
         <form id="ContactDetails" method="post" action="SaveContact.php">
            ...
            <tr>
               <td>
                  <h4 style = "font-family:Times New Roman">First Name:</h4>
               </td>
            </tr>
            <tr>
            ...
            <tr>
               <td>
                  <h4 style = "font-family:Times New Roman">Last Name:</h4>
               </td>
            </tr>
            <tr>
            ...
            <tr>
               <td>
                  <h4 style = "font-family:Times New Roman">Email:</h4>
               </td>
            </tr>
            <tr>
               <td>
            ...
            <tr>
               <td>
                  <h4 style = "font-family:Times New Roman">Home Phone:</h4>
               </td>
            </tr>
            <tr>
            ...
            <tr>
               <td>
                  <h4 style = "font-family:Times New Roman">Cell Phone:</h4>
               </td>
            </tr>
            <tr>
            ...
            <tr>
               <td>
                  <h4 style = "font-family:Times New Roman">Full Address:</h4>
               </td>
            </tr>
            ...
            <tr>
               <td>
                  <h4 style = "font-family:Times New Roman">Comments:</h4>
               </td>
            </tr>
            <textarea name="Comments" placeholder="Comments" rows="5" cols="30"><?if ($Comments != "") echo $Comments; ?></textarea>
            <h4 style = "font-family:Times New Roman">Interested In:</h4>
            <table border="0">
               <tr>
                  <td>
